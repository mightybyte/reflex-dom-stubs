...
type JSObjectRef = Ptr Int
type JSCSize = Ptr Int

data JSObjectCallAsFunctionCallback = JSObjectCallAsFunctionCallback
...
jsobjectmake = undefined
jsobjectmakefunctionwithcallback = undefined
jsobjectsetproperty = undefined
